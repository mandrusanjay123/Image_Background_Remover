  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div >
            ...
            <p className='my-6 text-[15px]  text-gray-500' >Imm the dummy text Imm the dummy text Imm the dummy text Imm the dummy text <br className='max-sm:hidden'/> you are the dummy text you are the dummy text you are the dummy text you are the dummy text</p>
            <div>
